...
function infobox(text,r,g,b)
	...
	localPlayer:sendNotification(infoboxText,r,g,b)
...
function dxDrawInfobox()
    ...
    dxDrawRectangle(613*(x/1440), 76*(y/900), 210*(x/1440), 6*(y/900), tocolor(240, 100, 0, 150), false)
    dxDrawText(infoboxText, 617*(x/1440), 0*(y/900), 819*(x/1440), 72*(y/900), tocolor(infoboxR,infoboxG,infoboxB, 150), 1.20*(y/900), "default", "center", "center", false, true, false, false, false)
end